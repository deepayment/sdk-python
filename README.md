...
[`protocol/`](https://github.com/deepayment/sdk-python/tree/main/protocol/) is the source of truth, shared with the Go / JavaScript /
...
```python
from deepayment import APIError, Client, CreatePaymentReq, RequestError, ResponseError, TransportError

client = Client(
    base_url="https://panama.deepayment.com",          # production origin; no /api/v1
...
[`protocol/merchant-api.md`](https://github.com/deepayment/sdk-python/blob/main/protocol/merchant-api.md#client-side-validation).
...
[`protocol/webhook.md`](https://github.com/deepayment/sdk-python/blob/main/protocol/webhook.md) and
[`protocol/merchant-api.md`](https://github.com/deepayment/sdk-python/blob/main/protocol/merchant-api.md). Key points:
...
The tests assert directly against the [`protocol/testdata`](https://github.com/deepayment/sdk-python/tree/main/protocol/testdata/)
